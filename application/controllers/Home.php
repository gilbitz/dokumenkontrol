...
class Home extends CI_Controller {
  ...
  protected function src($srcdata=false)
  {
	...
	public function search($offset=0)
	{
		...
		*/
		...
		$data['countArsip'] = $this->Admin_model->count_dataarsip();
  ...
  public function dl()
  {
  	...
  	$this->excel->getActiveSheet()->setCellValueByColumnAndRow(3, 2, 'Jenis Proyek');
	$this->excel->getActiveSheet()->setCellValueByColumnAndRow(4, 2, 'Nama Proyek / Dokumen');  
  	$this->excel->getActiveSheet()->setCellValueByColumnAndRow(5, 2, 'Status Dokumen');
  	$this->excel->getActiveSheet()->setCellValueByColumnAndRow(6, 2, 'Pencipta');
  	$this->excel->getActiveSheet()->setCellValueByColumnAndRow(7, 2, 'Pengolah / Pengontrol');
	...
	$no=1;
	  ...
	  $this->excel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $d['nobox']);	
  	...
  	$filename='Data Dokumen -'.getdate()[0].'.xls'; //save our workbook as this file name
